...
<section class="index-sec-1">
   ...
   <img src="assets/images/bann-fire-2.png" class="img-fluid bann-fire-2">
   <img src="assets/images/banner-fire-3.png" class="img-fluid bann-fire-3">
   <img src="assets/images/banner-fire-4.png" class="img-fluid bann-fire-4">
</section>
<section class="privacy-sec-1">
   <div class="container">
      <div class="sec-2wrap sec3-head">
         <div class="sec-2content mt-4">
            <p class="sec2-text1 headings">Privacy Policy</p>
         </div>
         <div>
            <p>Kidocop (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy Policy explains how your personal
               information is collected, used, and disclosed by Kidocop.
            </p>
            <p>This Privacy Policy applies to our website, and its associated subdomains (collectively, our “Service”) alongside our application,
               Kidocop. By accessing or using our Service, you signify that you have read, understood, and agree to our collection,
               storage, use, and disclosure of your personal information as described in this Privacy Policy and our Terms of Service.
            </p>
            <h2 class="sec2-text1 headings  mt-4 mb-2">Definitions and key terms</h2>
            <p class="mb-3">To help explain things as clearly as possible in this Privacy Policy, every time any of these terms are referenced, are strictly
               defined as:
            </p>
            <ul>
               ...
               <li>● Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to Kidocop, that is responsible for your information under this Privacy Policy.</li>
               <li>● Country: where Kidocop or the owners/founders of Kidocop are based, in this case is United States</li>
               <li>● Customer: refers to the company, organization or person that signs up to use the Kidocop Service to manage the relationships with your consumers or service users.</li>
               <li>● Device: any internet connected device such as a phone, tablet, computer or any other device that can be used to visit
                  Kidocop and use the services.
               </li>
               ...
               <li>● Personnel: refers to those individuals who are employed by Kidocop or are under contract to perform a service on behalf of one of the parties.</li>
               ...
               <li>● Service: refers to the service provided by Kidocop as described in the relative terms (if available) and on this platform.</li>
               ...
               <li>● Website: Kidocop."’s" site, which can be accessed via this URL:</li>
               <li>● You: a person or entity that is registered with Kidocop to use the Services.</li>
            </ul>
            <h2 class="sec2-text1 headings  mt-4 mb-2">What Information Do We Collect?</h2>
            <p class="mb-3">We collect information from you when you visit our app, register on our site, place an order, subscribe to our newsletter, respond to a survey or fill out a form.</p>
            <ul>
               <li>●  Name / Username</li>
            </ul>
            <h2 class="sec2-text1 headings  mt-4 mb-2">How Do We Use The Information We Collect?</h2>
            <P class="mb-3">Any of the information we collect from you may be used in one of the following ways:</P>
            <ul>
            ...
            <h2 class="sec2-text1 headings  mt-4 mb-2">When does KidoCop use end user information from third parties?</h2>
            <p class="mb-3">KidoCop will collect End User Data necessary to provide the KidoCop services to our customers.</p>
            ...
            <h2 class="sec2-text1 headings  mt-4 mb-2">When does KidoCop use customer information from third parties?</h2>
            <p>We receive some information from the third parties when you contact us. For example, when you submit your email address to
               us to show interest in becoming a KidoCop customer, we receive information from a third party that provides automated fraud
               detection services to KidoCop. We also occasionally collect information that is made publicly available on social media websites.
            ...
            <!--<h2 class="sec2-text1 headings  mt-4 mb-2">Information automatically collected</h2>-->
            ...
            <h2 class="sec2-text1 headings  mt-4 mb-2">Do we share the information we collect with third parties?</h2>
            <p class="mb-3"> We may share the information that we collect, both personal and non-personal, with third parties such as advertisers, contest
            ...
            <p class="mb-3">We may engage trusted third party service providers to perform functions and provide services to us, such as hosting and
            ...
            <h2 class="sec2-text1 headings  mt-4 mb-2">Where and when is information collected fromcustomers and end users?</h2>
            <p> KidoCop will collect personal information that you submit to us. We may also receive personal information about you from thirdparties as described above.</p>
            <h2 class="sec2-text1 headings  mt-4 mb-2">How Do We Use Your Email Address?</h2>
            ...
            <h2 class="sec2-text1 headings  mt-4 mb-2">How Long Do We Keep Your Information?</h2>
            <p> We keep your information only so long as we need it to provide KidoCop to you and fulfill the purposes described in this policy.
            ...
            <h2 class="sec2-text1 headings  mt-4 mb-2">How Do We Protect Your Information?</h2>
            <p> We implement a variety of security measures to maintain the safety of your personal information when you place an order or
               ...
               file. We cannot, however, ensure or warrant the absolute security of any information you transmit to KidoCop or guarantee that
            ...
            <h2 class="sec2-text1 headings  mt-4 mb-2">Could my information be transferred to other countries?</h2>
            <p> KidoCop is incorporated in United States. Information collected via our website, through direct interactions with you, or from use
            ...
            <h2 class="sec2-text1 headings  mt-4 mb-2">Is the information collected through the KidoCop Service secure?</h2>
            ...
            <h2 class="sec2-text1 headings  mt-4 mb-2">Can I update or correct my information?</h2>
            <p class="mb-3">The rights you have to request updates or corrections to the information KidoCop collects depend on your relationship with
               KidoCop. Personnel may update or correct their information as detailed in our internal company employment policies.
            </p>
            <p class="mb-3">Customers have the right to request the restriction of certain uses and disclosures of personally identifiable information as
            ...
            <p class="mb-3">You should be aware that it is not technologically possible to remove each and every record of the information you have
            ...
            <p>If you are an end user and wish to update, delete, or receive any information we have about you, you may do so by contacting
               the organization of which you are a customer.
            </p>
            <h2 class="sec2-text1 headings  mt-4 mb-2">Sale of Business</h2>
            <p>We reserve the right to transfer information to a third party in the event of a sale, merger or other transfer of all or substantially all of the assets of Kidocop or any of its Corporate Affiliates (as defined herein), or that portion of Kidocop or any of its Corporate Affiliates to which the Service relates, or in the event that we discontinue our business or file a petition or have filed against us a petition in bankruptcy, reorganization or similar proceeding, provided that the third party agrees to adhere to the terms of this Privacy Policy.</p>
            <h2 class="sec2-text1 headings  mt-4 mb-2">Affiliates</h2>
            <p>We may disclose information (including personal information) about you to our Corporate Affiliates. For purposes of this Privacy Policy, "Corporate Affiliate" means any person or entity which directly or indirectly controls, is controlled by or is under common control with Kidocop, whether by ownership or otherwise. Any information relating to you that we provide to our Corporate Affiliates will be treated by those Corporate Affiliates in accordance with the terms of this Privacy Policy.</p>
            <h2 class="sec2-text1 headings  mt-4 mb-2">Governing Law</h2>
            <p class="mb-3">This Privacy Policy is governed by the laws of United States without regard to its conflict of laws provision. You consent to the exclusive jurisdiction of the courts in connection with any action or dispute arising between the parties under or in connection with this Privacy Policy except for those individuals who may have rights to make claims under Privacy Shield, or the Swiss-US framework.</p>
            <p class="mb-3">The laws of United States, excluding its conflicts of law rules, shall govern this Agreement and your use of the app. Your use of the app may also be subject to other local, state, national, or international laws.</p>
            <p>By using Kidocop or contacting us directly, you signify your acceptance of this Privacy Policy. If you do not agree to this Privacy Policy, you should not engage with our website, or use our services. Continued use of the website, direct engagement with us, or following the posting of changes to this Privacy Policy that do not significantly affect the use or disclosure of your personal information will mean that you accept those changes.</p>
            <h2 class="sec2-text1 headings  mt-4 mb-2">Your Consent</h2>
            ...
            <h2 class="sec2-text1 headings  mt-4 mb-2">Links to Other Websites</h2>
            <p>This Privacy Policy applies only to the Services. The Services may contain links to other websites not operated or controlled by Kidocop. We are not responsible for the content, accuracy or opinions expressed in such websites, and such websites are not investigated, monitored or checked for accuracy or completeness by us. Please remember that when you use a link to go from the Services to another website, our Privacy Policy is no longer in effect. Your browsing and interaction on any other website, including those that have a link on our platform, is subject to that website’s own rules and policies. Such third parties may use their own cookies or other methods to collect information about you.</p>
            <h2 class="sec2-text1 headings  mt-4 mb-2">Advertising</h2>
            <p class="mb-3">This app may contain third party advertisements and links to third party sites. Kidocop does not make any representation as to the accuracy or suitability of any of the information contained in those advertisements or sites and does not accept any responsibility or liability for the conduct or content of those advertisements and sites and the offerings made by the third parties.</p>
            <p class="mb-3">Advertising keeps Kidocop and many of the websites and services you use free of charge. We work hard to make sure that ads are safe, unobtrusive, and as relevant as possible.</p>
            <p>Third party advertisements and links to other sites where goods or services are advertised are not endorsements or recommendations by Kidocop of the third party sites, goods or services. Kidocop takes no responsibility for the content of any of the ads, promises made, or the quality/reliability of the products or services offered in all advertisements.</p>
            <h2 class="sec2-text1 headings  mt-4 mb-2">Cookies for Advertising</h2>
            ...
            <h2 class="sec2-text1 headings  mt-4 mb-2">Cookies</h2>
            <p>Kidocop uses "Cookies" to identify the areas of our website that you have visited. A Cookie is a small piece of data stored on your computer or mobile device by your web browser. We use Cookies to enhance the performance and functionality of our app but are non-essential to their use. However, without these cookies, certain functionality like videos may become unavailable or you would be required to enter your login details every time you visit the app as we would not be able to remember that you had logged in previously. Most web browsers can be set to disable the use of Cookies. However, if you disable Cookies, you may not be able to access functionality on our website correctly or at all. We never place Personally Identifiable Information in Cookies.</p>
            <h2 class="sec2-text1 headings  mt-4 mb-2">Blocking and disabling cookies and similar technologies</h2>
            ...
            <!--<h2 class="sec2-text1 headings  mt-4 mb-2">Remarketing Services</h2>-->
            ...
            <h2 class="sec2-text1 headings  mt-4 mb-2">Payment Details</h2>
            ...
            <h2 class="sec2-text1 headings  mt-4 mb-2">Kids' Privacy</h2>
            ...
            <h2 class="sec2-text1 headings  mt-4 mb-2">Changes To Our Privacy Policy</h2>
            ...
            <h2 class="sec2-text1 headings  mt-4 mb-2">Third-Party Services</h2>
            <p class="mb-3">We may display, include or make available third-party content (including data, information, applications and other products services) or provide links to third-party websites or services ("Third- Party Services").</p>
            <p class="mb-3">You acknowledge and agree that Kidocop shall not be responsible for any Third-Party Services, including their accuracy, completeness, timeliness, validity, copyright compliance, legality, decency, quality or any other aspect thereof. Kidocop does not assume and shall not have any liability or responsibility to you or any other person or entity for any Third-Party Services.</p>
            ...
            <h2 class="sec2-text1 headings  mt-4 mb-2">Information about General Data Protection Regulation(GDPR)</h2>
            ...
            <h2 class="sec2-text1 headings  mt-4 mb-2">What is GDPR?</h2>
            <p class="mb-3">GDPR is an EU-wide privacy and data protection law that regulates how EU residents' data is protected by companies and enhances the control the EU residents have, over their personal data.</p>
            ...
            <h2 class="sec2-text1 headings  mt-4 mb-2">What is personal data?</h2>
            <p class="mb-3">Any data that relates to an identifiable or identified individual. GDPR covers a broad spectrum of information that could be used on its own, or in combination with other pieces of information, to identify a person. Personal data extends beyond a person’s name or email address. Some examples include financial information, political opinions, genetic data, biometric data, IP addresses, physical address, sexual orientation, and ethnicity.</p>
            <p class="mb-3">The Data Protection Principles include requirements such as:</p>
            <ul>
            ...
            <h2 class="sec2-text1 headings  mt-4 mb-2">Why is GDPR important?</h2>
            <p>GDPR adds some new requirements regarding how companies should protect individuals' personal data that they collect and process. It also raises the stakes for compliance by increasing enforcement and imposing greater fines for breach. Beyond these facts it's simply the right thing to do. At Kidocop we strongly believe that your data privacy is very important and we already have solid security and privacy practices in place that go beyond the requirements of this new regulation.</p>
            <h2 class="sec2-text1 headings  mt-4 mb-2">Individual Data Subject's Rights - Data Access,
               Portability and Deletion
            </h2>
            <p>We are committed to helping our customers meet the data subject rights requirements of GDPR. Kidocop processes or stores all personal data in fully vetted, DPA compliant vendors. We do store all conversation and personal data for up to 6 years unless your account is deleted. In which case, we dispose of all data in accordance with our Terms of Service and Privacy Policy, but we will not hold it longer than 60 days.</p>
            ...
            <h2 class="sec2-text1 headings  mt-4 mb-2">California Residents</h2>
            <p class="mb-3">The California Consumer Privacy Act (CCPA) requires us to disclose categories of Personal Information we collect and how we use it, the categories of sources from whom we collect Personal Information, and the third parties with whom we share it, which we have explained above.</p>
            <p class="mb-3">We are also required to communicate information about rights California residents have under California law. You may exercise the following rights:</p>
            <ul class="mb-3">
            ...
            <p class="mb-3">We do not sell the Personal Information of our users.</p>
            <p>For more information about these rights, please contact us.</p>
            <h2 class="sec2-text1 headings  mt-4 mb-2">California Online Privacy Protection Act (CalOPPA)</h2>
            <p class="mb-3">CalOPPA requires us to disclose categories of Personal Information we collect and how we use it, the categories of sources from whom we collect Personal Information, and the third parties with whom we share it, which we have explained above.</p>
            <p class="mb-3">CalOPPA users have the following rights:</p>
            <ul class="mb-3">
               <li>● Right to Know and Access. You may submit a verifiable request for information regarding the: (1) categories of Personal Information we collect, use, or share; (2) purposes for which categories of Personal Information are collected or used by us; (3) categories of sources from which we collect Personal Information; and (4) specific pieces of Personal Information we have collected about you.</li>
               <li>● Right to Equal Service. We will not discriminate against you if you exercise your privacy rights.</li>
               <li>● Right to Delete. You may submit a verifiable request to close your account and we will delete Personal Information about you that we have collected.</li>
            ...
            <p class="mb-3">We do not sell the Personal Information of our users.</p>
            <p>For more information about these rights, please contact us.</p>
            <h2 class="sec2-text1 headings  mt-4 mb-2">Contact Us</h2>
            <p  >Don't hesitate to contact us if you have any questions.</p>
            <ul>
               <li>Via Email:leilachaychi@gmail.com</li>
            </ul>
         </div>
      </div>
   </div>
